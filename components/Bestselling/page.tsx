  ...
  return (
    <>
      <div className="container mx-auto">
        ...
        <div>
          <hr className="h-px my-10 mb-4 bg-gray-200 border-0 dark:bg-gray-700" />
        </div>
        <div className="flex items-center">
          <span className="inline-block bg-ecred h-7 rounded-sm w-3 mr-2"></span>
        ...
        <div className=" py-2">
          <div className="grid grid-cols-8 items-center gap-4 mb-2 mt-2">
            ...
            <button className="bg-ecred text-white py-3 px-9 rounded-sm text-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-opacity-50">
              View All
            </button>
            </div>
          </div>
        ...
        <div className=" p-6">
          ...
          <div className="grid grid-cols-4 gap-8">
            <div className="relative w-100 overflow-hidden rounded-sm bg-white">
              <div className="absolute left-0 top-0 rounded-br-md bg-ecred px-2 py-1 text-xs font-bold text-white">
                40%
              </div>
              ...
              <div className="p-2">
                ...
                <div className="mt-1 flex items-baseline">
                  <span className="text-sm font-bold text-red-600">$400</span>
