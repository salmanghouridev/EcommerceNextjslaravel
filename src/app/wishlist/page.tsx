      ...
      <div className="container mx-auto mt-10">
        <div className=" py-2">
          <div className="flex justify-between mb-2 mt-2">
            <div>
              <h1 className="text-lg font-medium tracking-wide	 col-span-2">
                Wishlist (4)
              </h1>
            </div>
            <div>
              <button className="border-2 border-gray-200 px-8 py-3 text-xs font-semibold">
                Move All To Bag
              </button>
            </div>
          </div>
        ...
        <div className="flex justify-between mt-10">
          <div className="flex items-center">
            <span className="inline-block bg-red-500 h-8 rounded-sm w-4 mr-2"></span>
            <h1 className="inline text-sm font-semibold text-black">
              Just For you
            </h1>
          </div>
          <div>
